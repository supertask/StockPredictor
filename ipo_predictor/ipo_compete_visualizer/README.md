...
https://blog.g-gen.co.jp/entry/google-maps-gemini-review-analysis


## Nearby Search API. 1,000 回あたり 32.00 米ドル
dataframeとしては場所ID, 場所名, 緯度, 経度, 評価, レビュー数をCSVに保存する。
3ジムx200件とするとこれだけで12.8ドル

https://zenn.dev/tomlla/articles/8216f786aeffe8

## Place Details API. 1,000 回あたり 17.00 米ドル
...
https://chatgpt.com/share/671944cf-2c80-8010-acab-73dd25e05f15
