...
start_dt: datetime = today.replace(hour=0, minute=0, second=0, microsecond=0) - timedelta(days=(HISTORICAL_DATA_YEARS*365))
...
#datetime			
#2022-10-31	5929	0.065607	-0.063393
#2022-10-31	9600	0.065760	-0.059093
#...